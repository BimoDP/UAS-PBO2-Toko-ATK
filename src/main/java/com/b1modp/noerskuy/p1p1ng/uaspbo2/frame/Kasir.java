 ...
 public void addtable(int id, String name, int qty, double price) {
   ...
   public void Bill() {
        ...
        try {
           ...
           b.setText("                         Toko ATK Poyubim\n");
            b.setText(b.getText() + "                         Banjarbaru, \n");
            b.setText(b.getText() + "                         +62 811713612, \n");
            b.setText(b.getText() + "-------------------------------------------------------------------------\n");
            ...
            b.setText(b.getText() + "-------------------------------------------------------------------------\n");
            b.setText(b.getText() + "                     Terima Kasih...!"+"\n");
            b.setText(b.getText() + "-------------------------------------------------------------------------\n");
   ...
   // pat btn action
    ...
    private void initComponents() {
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/10.jpg"))); // NOI18N
        ...
        jButton9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/7.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        addtables(1, "Pulpen Joyko", i, 5000.00);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        addtables(2, "Penggaris", i, 8000.00);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        addtables(3, "Selotip Kecil", i, 3500.00);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        addtables(6, "Gunting", i, 15000.00);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        addtables(4, "Kalkulator", i, 35000.00);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        addtables(9, "Kertas A4", i, 50000.00);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        addtables(8, "Paper Clip", i, 2700.00);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        addtables(7, "Buku Saku", i, 15300.00);
